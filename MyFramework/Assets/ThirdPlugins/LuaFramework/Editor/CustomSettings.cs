...
{
    public static string saveDir = Application.dataPath + "/ThirdPlugins/LuaFramework/ToLua/Source/Generate/";
    public static string toluaBaseType = Application.dataPath + "/ThirdPlugins/LuaFramework/ToLua/BaseType/";
    ...
    {                
        ...
        _GT(typeof(UnityEngine.Matrix4x4)),
        ...
        //MyFramework
        _GT(typeof(AppConfig)),
        _GT(typeof(AppPathConfig)),
        _GT(typeof(FilesTools)),
        _GT(typeof(CommonTools)),
        _GT(typeof(LuaHelpTools)),
        _GT(typeof(ModelContorlBase)),
        _GT(typeof(LuaModelControlBase)),
        _GT(typeof(ModelCompBase)),
        _GT(typeof(ManagerBase)),
        _GT(typeof(Manager_ManagerModel)),

        //MyFramework_Model
        _GT(typeof(LuaManagerModel)),
        _GT(typeof(LuaServiceModel)),
        //第三方插件
