...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase>), factory.MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase);
		...
		DelegateTraits<MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase>>.Init(factory.MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase);
		...
		TypeTraits<MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase>>.Init(factory.Check_MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase);
		...
		StackTraits<MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase>>.Push = factory.Push_MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase;
	}
	...
	class MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase_Event : LuaDelegate
	{
		public MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase_Event(LuaFunction func) : base(func) { }
		public MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(MyFramework.ManagerContorBase param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(MyFramework.ManagerContorBase param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase> MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase> fn = delegate(MyFramework.ManagerContorBase param0) { };
			return fn;
		}

		if(!flag)
		{
			MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase_Event target = new MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase_Event(func);
			MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase_Event target = new MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase_Event(func, self);
			MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase>), L, pos);
	}

	void Push_MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase(IntPtr L, MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase> o)
	{
		ToLua.Push(L, o);
	}
