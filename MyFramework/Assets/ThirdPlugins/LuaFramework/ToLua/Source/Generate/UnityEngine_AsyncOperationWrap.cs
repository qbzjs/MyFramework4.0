...
public class UnityEngine_AsyncOperationWrap
{
	...
	static int set_completed(IntPtr L)
	{
		try
		{
			...
			{
				System.Action<UnityEngine.AsyncOperation> ev = (System.Action<UnityEngine.AsyncOperation>)DelegateTraits<System.Action<UnityEngine.AsyncOperation>>.Create(arg0.func);
				obj.completed += ev;
			}
