...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		MyFramework_AppConfigWrap.Register(L);
		MyFramework_AppPathConfigWrap.Register(L);
		MyFramework_FilesToolsWrap.Register(L);
		MyFramework_CommonToolsWrap.Register(L);
		MyFramework_LuaHelpToolsWrap.Register(L);
		MyFramework_ModelContorlBaseWrap.Register(L);
		MyFramework_LuaModelControlBaseWrap.Register(L);
		MyFramework_ModelCompBaseWrap.Register(L);
		MyFramework_ManagerBaseWrap.Register(L);
		MyFramework_Manager_ManagerModelWrap.Register(L);
		MyFramework_LuaManagerModelWrap.Register(L);
		MyFramework_LuaServiceModelWrap.Register(L);
		MyFramework_ManagerContorBaseWrap.Register(L);
		MyFramework_ManagerBase_MyFramework_Manager_ManagerModel_MyFramework_ManagerContorBaseWrap.Register(L);
		MyFramework_ManagerContorBase_MyFramework_LuaManagerModelWrap.Register(L);
		MyFramework_LuaModelControlBase_MyFramework_LuaServiceModelWrap.Register(L);
		L.RegFunction("ModelLoadBackCall_MyFramework_ManagerContorBase", MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase);
		L.EndModule();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int MyFramework_ModelLoadBackCall_MyFramework_ManagerContorBase(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<MyFramework.ModelLoadBackCall<MyFramework.ManagerContorBase>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
