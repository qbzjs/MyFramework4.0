...
public class UnityEngine_ApplicationWrap
{
	...
	static int set_lowMemory(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.Application.LowMemoryCallback ev = (UnityEngine.Application.LowMemoryCallback)DelegateTraits<UnityEngine.Application.LowMemoryCallback>.Create(arg0.func);
	...
	static int set_logMessageReceived(IntPtr L)
	{
		try
		{
			...
			if (arg0.op == EventOp.Add)
			{
				UnityEngine.Application.LogCallback ev = (UnityEngine.Application.LogCallback)DelegateTraits<UnityEngine.Application.LogCallback>.Create(arg0.func);
	...
	static int set_wantsToQuit(IntPtr L)
	{
		try
		{
			...
			if (arg0.op == EventOp.Add)
			{
				System.Func<bool> ev = (System.Func<bool>)DelegateTraits<System.Func<bool>>.Create(arg0.func);
